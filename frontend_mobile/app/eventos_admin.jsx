...
export default function EventosAdminScreen() {
  ...
  const handleEdit = (evento) => {
    ...
    setPrecoVisitante(String(evento.preco_visitante || ""));

    setPrecoParticipante(String(evento.preco_participante || ""));

    setLimiteParticipantes(String(evento.limite_participantes || ""));
        ...
        {eventos.map((evento) => (
          ...
          >
            ...
            >
              ...
              {(user?.role === "admin" || evento.user_id === user?.id) && (
                <View
                  style={{
                    flexDirection: "row",
                    gap: 12,
